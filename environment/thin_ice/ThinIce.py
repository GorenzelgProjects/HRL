...
class Game():
    ...
    def __init__(self, settings: dict):
        ...
        pg.display.set_icon(pg.image.load('./thin_ice/data/images/icon.png'))
    ...
    def loadMap(self):
        ...
        fileName = "thin_ice/data/maps/level%d.txt" % self.currentLevel
    ...
    def new(self):
        ...
        self.player = Player(self, 0, 0, self.settings)
...
class TitleScreen():
    ...
    def loadData(self):
        ...
        self.clickSound = pg.mixer.Sound("thin_ice/data/sound/move.ogg")
...
class ScoreScreen():
    ...
    def loadData(self):
        ...
        # Loads the Background music
        pg.mixer.music.load('thin_ice/data/sound/winner.ogg')
        pg.mixer.music.set_volume(0.1)

        # Instantiate the font used for the game
        self.font = pg.font.Font("thin_ice/data/font/arcade.ttf", 18) 
        
        # Puffle image
        self.puffle= pg.image.load("thin_ice/data/images/puffle.png")
        
        # Sound effect when a line loads
        self.lineSound = pg.mixer.Sound("thin_ice/data/sound/move.ogg")
        self.lineSound.set_volume(0.2)
               
        # Sound effect when the puffle loads
        self.puffleSound = pg.mixer.Sound("thin_ice/data/sound/allTileComplete.ogg")
