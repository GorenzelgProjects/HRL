...
class Button(pg.sprite.Sprite):
    ...
    def __init__(self, game, buttonType, xCoordinate, yCoordinate, width, height):
        ...
        if buttonType == "reset":
            self.buttonImages = ["thin_ice/data/images/resetButtonOne.png", "thin_ice/data/images/resetButtonTwo.png"]
            
        elif buttonType == "start":
            self.buttonImages = ["thin_ice/data/images/startButtonOne.png", "thin_ice/data/images/startButtonTwo.png"]
            
        elif buttonType == "play":
            self.buttonImages = ["thin_ice/data/images/playButtonOne.png", "thin_ice/data/images/playButtonTwo.png"]
            
        else:
            self.buttonImages = ["thin_ice/data/images/finishButtonOne.png", "thin_ice/data/images/finishButtonTwo.png"]
